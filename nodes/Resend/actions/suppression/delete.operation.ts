...
export const description: INodeProperties[] = [
  createDynamicIdField({
    ...
    description:
      'The suppression to remove. Select from the list, or enter a suppression ID or the suppressed email address directly. Removing it lets Resend send to this address again.',
    displayOptions: {
      show: {
